...
namespace AdventOfCode2020
{
    class Program
    {
        ...
        /// <summary>
        /// Method that takes the given <see cref="Environment.NewLine"/> separated values and 
        /// converts it into an <see cref="IEnumerable{T}"/> list.
        /// </summary>
        /// <returns>An <see cref="IEnumerable{T}"/> containing the list of rules.</returns>
        static string[] Day7Inputs() => @"posh teal bags contain 2 faded coral bags, 3 striped crimson bags, 1 faded red bag.
