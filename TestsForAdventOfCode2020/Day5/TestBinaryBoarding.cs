...
namespace TestsForAdventOfCode2020.Day5
{
    [TestClass]
    public class TestBinaryBoarding
    {
        ...
        {
            var binaryBoarding = new AdventOfCode2020.Day5.BinaryBoarding(input);
        ...
        public void Incorrect_input_length_throws_exception(string input)
        {
            try
            {
                var bb = new AdventOfCode2020.Day5.BinaryBoarding(input);
            }
        ...
        public void Null_input_throws_exception()
        {
            try
            {
                var bb = new AdventOfCode2020.Day5.BinaryBoarding(null);
            }
