...
namespace TestsForAdventOfCode2020.Day7
{
    ...
    public class TestHandyHaversack
    {
        ...
        {
            var rules = AdventOfCode2020.Day7.HaversackRuleConverter.ConvertToRules(Part1Input);
        ...
        {
            var rules = AdventOfCode2020.Day7.HaversackRuleConverter.ConvertToRules(Part2Input);
            var bag = new AdventOfCode2020.Day7.HandyHaversack(rules, "shinygold");
        ...
        {
            var rules = AdventOfCode2020.Day7.HaversackRuleConverter.ConvertToRules(Part2Input);
            var bag = new AdventOfCode2020.Day7.HandyHaversack(rules, color);
...
dotted black bags contain no other bags.".Split(new[] { Environment.NewLine }, StringSplitOptions.RemoveEmptyEntries);
            var rules = AdventOfCode2020.Day7.HaversackRuleConverter.ConvertToRules(input);
            var bag = new AdventOfCode2020.Day7.HandyHaversack(rules, "shinygold");
